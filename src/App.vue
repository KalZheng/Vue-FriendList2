<template>
  <section>
    ...
    <button @click="toggleAddShow">Add</button>
    <new-friend v-if="showNewFriend" @add-friend="addFriendData"></new-friend>
    <ul>
      <friend-contact
